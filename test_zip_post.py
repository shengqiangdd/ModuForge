...
# 4. Export zip (POST method!)
print('4. Exporting zip (POST)...')
...
print('6. Downloading and analyzing...')
sftp = ssh.open_sftp()
try:
    local_path = r'C:\Users\22875\.qwenpaw\workspaces\default\ModuForge\build_artifacts\test_module_v4.zip'
