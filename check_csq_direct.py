...
print('\n=== csq PROJECTS (user_id containing a4c50d84) ===')
...
for r in cur.execute('SELECT user_id, COUNT(*) FROM notifications GROUP BY user_id'):
    print(f'  user={r[0]}: {r[1]} notifications')
